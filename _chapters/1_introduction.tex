...
Sebbene questa pratica possa avvicinare la curva della scoperta degli errori a quella di produzione degli stessi, questa introduce ancora più inceretezza rispetto al testing empirico, in quanto il modello simulato potrebbe non essere completamente fedele al software reale, avendo quindi un'affidabilità ancora più bassa.
